    ...
    <div class="container">
        <div class="payment-form">
            ...
            <div class="form-group">
                ...
                <input type="text" name="plan_name" value="6 Months" readonly>
            </div>
            <div class="form-group">
                <label>Plan Price</label>
                <input type="text" name="plan_price" value="₹6500.00" readonly>
            </div>
        </div>

        <div class="plan-details">
            <h2>6 Months <a href="index.html" class="change-plan">Change plan</a></h2>
