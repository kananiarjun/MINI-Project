    ...
    <div class="container">
        <div class="payment-form">
            ...
            <div class="form-group">
                ...
                <input type="text" name="plan_name" value="12 Months" readonly>
            </div>
            <div class="form-group">
                <label>Plan Price</label>
                <input type="text" name="plan_price" value="₹12500.00" readonly>
            </div>
        </div>

        <div class="plan-details">
            <h2>12 Months <a href="index.html" class="change-plan">Change plan</a></h2>
            <div class="price">₹12500.00</div>
